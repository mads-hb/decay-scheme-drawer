...
c12_2 = level(7.65, '0', '+', energy_format_string="%1.2f")
c12_many = level(7.65 + (12.7 - 7.65)/3.5, '', '', many=True, upper_energy=12.7 - (12.7 - 7.65)/3.5, hide_energy_spin_parity=True)
c12_3 = level(12.7, '1', '+', energy_format_string="%2.1f")
c12_4 = level(15.1, '1', '+', energy_format_string="%2.1f", text_above='IAS')
c12.add_level(c12_0)
c12.add_level(c12_1)
c12.add_level(c12_2)
...
be8a_gs = level(7.37, '0', '+', lw=2.0, text_below='$\mathrm{\\alpha+^{8}Be}$', energy_format_string="%2.2f", draw_reference_line=True)
n12.add_level(be8a_gs)
be8a_broad = level(10.4, '2', '+', broad=True, upper_energy=10.4+0.75, energy_format_string="%2.1f")
n12.add_level(be8a_broad)
...
ds.add_freetext(freetext('$(0,2)^{+}$', 2.3, 12.7 - (12.7 - 7.65)/3.5 + 0.1, va='bottom', ha='right'))
